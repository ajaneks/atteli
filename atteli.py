...
new_image = image.resize((600,400), Image.ANTIALIAS)
new_image.save('11.jpg')

image = Image.open('2.jpg')
new_image = image.resize((400, 400), Image.ANTIALIAS)
...
new_image = image.resize((250,400), Image.ANTIALIAS)
new_image.save('55.jpg')

image = Image.open('6.jpg')
new_image = image.resize((650,400), Image.ANTIALIAS)
new_image.save('66.jpg')

image = Image.open('7.jpg')
new_image = image.resize((300,400), Image.ANTIALIAS)
...
def forward(img_no):
	...
	button_forward = Button(root, text="Talak", command=lambda: forward(img_no+1))
...
button_forward = Button(root, text="Talak", command=lambda: forward(2))
